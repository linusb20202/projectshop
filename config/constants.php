<?php
$inc_controller = new App\Http\Controllers\Controller();
$siteSetting = $inc_controller->getSiteSetting();

define('SITE_TITLE', $siteSetting->site_title);
define('TITLE_FOR_LAYOUT', ' :: ' . SITE_TITLE);
define('HTTP_PATH', 'http://laravel.seenshop.com');
define("BASE_PATH", $_SERVER['DOCUMENT_ROOT']);
define('MAIL_FROM', 'office@preffort.com');
define('CURR', '$');
define('API_KEY', 'LSA0E14C7409G98I14GGF9946ER');

define('CAPTCHA_KEY', '6LcovbYZAAAAACTkkuKzSY4ocSy2kxyygA3O2qhm');
define('SECRET_KEY', '6LcovbYZAAAAADjveSBXiVQtWM6Ii8OFHfaNstP4');
define('IS_LIVE', 0);
define('IS_DEMO', 0);
...
define('PAYPAL_EMAIL', 'sb-9kkog1809362@business.example.com'); 
