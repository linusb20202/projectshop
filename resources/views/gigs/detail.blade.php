            ...
            <div class="row">
                <div class="col-xs-12 col-md-8">
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-xs-12 md-12"  >
                                <div class="gig-page-packages-table" id="related"><h3 class="section-title" style="margin-bottom:15px;margin-top:15px;">Other Gigs Offered By <span style="color:#5CB85C;"><a href="../public-profile/{{$recordInfo->User->slug}}" style="color:#5CB85C;">{{ $recordInfo->User->user_name}}</a></span></h3>
